...
var geoj = csv2geojson.csv2geojson(`https://raw.githubusercontent.com/evantdailey/map_testing/master/site1.csv`, {
    latfield: 'Latitude',
    lonfield: 'Longitude'
}, function(err, data) {
  console.log(data);
...
for (i in groups) {
	...
	clusters[i] = new L.markerClusterGroup({
		iconCreateFunction: function(cluster) {
			...
			return new L.DivIcon({html:  '<div><span>' + childCount + '</span></div>', className: classGroup, iconSize: new L.Point(40, 40)});
		}
	});
